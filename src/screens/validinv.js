                ...
                />
                    ...
                    /> 
                     ...
                     {/*LIBELE INVENTAIRE */}
                      ...
                      style={{ width: '90%', fontSize: '13px' }}>
                         <option value="" disabled>Sélectionnez un inventaire</option>
                         <option value="Inventaire 1">Inventaire 1</option>
                         <option value="Inventaire 2">Inventaire 2</option>
                          <option value="Inventaire 3">Inventaire 3</option>
                        </select>
